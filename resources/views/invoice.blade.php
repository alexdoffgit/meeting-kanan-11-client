...
<html>
	...
	<body>
		...
		<article>
			...
			<table class="meta">
				<tr>
					<th><span class="block">Invoice #</span></th>
					<td><span class="block">{{ $invoiceData['payment_id'] }}</span></td>
				</tr>
				<tr>
					<th><span class="block">Date</span></th>
			...
			<table class="inventory">
				<thead>
					<tr>
						<th><span class="block">Nama Ruangan</span></th>
						<th><span class="block">Hari Mulai</span></th>
						<th><span class="block">Hari Selesai</span></th>
						<th><span class="block">Waktu Mulai</span></th>
						<th><span class="block">Waktu Selesai</span></th>
				...
				<tbody>
					...
					<tr>
						<td><span class="block">{{ $invoice['room_name'] }}</span></td>
