    ...
    <!-- /header -->
        ...
        <main>
                    ...
                    <ul class="clearfix">
                        ...
                        <li>
                            <div class="layout_view">
                                <a href="{{url('rooms/grid')}}"><i class="icon-th"></i></a>
                                <a href="{{url('rooms/list')}}" class="active"><i class="icon-th-list"></i></a>
                            </div>
                        </li>
                        <li>
                            {{-- preserve for layout --}}
            ...
            <div class="container margin_60_35">
                <form class="col-lg-12" action="{{ url('/search/list') }}" method="POST">
                    @csrf
                    <div class="row no-gutters custom-search-input-2 inner">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <input type="number" name="maxpeople" placeholder="Jumlah Tamu" min="1" class="form-control">
